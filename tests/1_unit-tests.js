...
suite('Unit Tests', () => {
  ...
  suite('Function ____()', () => {
    ...
    suite('American to British English', () => {
      ...
      test('Mangoes are my favorite fruit. --> Mangoes are my favourite fruit.', done => {
        ...
        assert.equal(output, Translator.translateSentence(input, "british"));
        done();
      });
    ...
    suite('British to American English', () => {
      ...
      test('We watched the footie match for a while. --> We watched the soccer match for a while.', done => {
        ...
        assert.equal(output, Translator.translateSentence(input, "american"));
        done();
      });
  ...
  suite('Function translateTitles()', () => {

    suite('American to British English', () => {
      test('mr. --> mr', done => {
        assert.equal("mr", Translator.translateTitles("mr.", "british"));
        done();
      });
    ...
    suite('British to American English', () => {
      test('mr --> mr.', done => {
        assert.equal("mr.", Translator.translateTitles("mr", "american"));
        done();
      });
  ...
  suite('Function translateTimes()', () => {

    suite('American to British English', () => {
      test('9:00 --> 9.00', done => {
        assert.equal("9.00", Translator.translateTimes("9:00", "british"));
        done();
      });

      test('14:53 --> 14.53', done => {
        assert.equal("14.53", Translator.translateTimes("14:53", "british"));
        done();
      });
    });
    ...
    suite('British to American English', () => {
      test('9.00 --> 9:00', done => {
        assert.equal("9:00", Translator.translateTimes("9.00", "american"));
        done();
      });

      test('14.53 --> 14:53', done => {
        assert.equal("14:53", Translator.translateTimes("14.53", "american"));
        done();
      });
    });
